...
public class FileStoreInfoObserver implements Observer {
	...
	public void update(Observable o, Object obj) {
		...
		} else if (obj instanceof FileMultipleInfo) { // 执行多语言的save方法

			FileMultipleInfo info = (FileMultipleInfo) obj;
	 ...
	 * 新增或者更新对应文件的商店多语言信息
	 */
	private void saveOrUpdateStoreInfo(FileMultipleInfo source, Long fiId,List<Store> stores) {
	...
	private void update(Long fiId, FileMultipleInfo source) {
	...
	private void save(FileMultipleInfo source,List<Store> stores,Long fiId){
