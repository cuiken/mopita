					...
					<div class="icon_set">
						<s:iterator value="catePage.result">
							...
							<a href="${ctx}/store/locker!details.action?id=${theme.id}&${queryString}">
								<img alt="${theme.title}" data-original="${ctx}/image.action?path=${theme.iconPath}" src="${ctx}/static/images/default.png" style="margin: 2px;" width="72" height="72" class="icon"/>
							</a>
							
						</s:iterator>
						
						<a href="${ctx}/store/locker!more.action?cid=${info.theme.categories[0].id}&${queryString}">							
